 ...
 *    
 *  Interactive GUI used to demonstrate the Autocomplete data type modified to recieve Airport Data.
 *
...
//    private static final String SEARCH_URL = "https://www.google.com/search?q=";
    ...
    public AutocompleteGUI(String filename, int k) {
        ...
        JLabel textLabel = new JLabel("Source:");
...
//                });
    ...
    public class AutocompletePanel extends JPanel {
        ...
        private JList<String> suggestions;                // a list of autocomplete matches (Java 6)
        ...
        public AutocompletePanel(String filename) {
            ...
            try {
                ...
                for (int i = 0; i < N; i++) {
                    ...
                    String weight = line.substring(0, tab).trim();
...
//                            searchOnline(searchText.getText());
        ...
        public String getSelectedText() {
            if (!suggestions.isSelectionEmpty()) {
                ...
                if (displayWeights) {
                    selection = selection.substring(selection.indexOf("grey"), selection.length());
                }
                selection = selection.replaceAll("\\<.*?>", "");
                selection = selection.replaceAll("^[ \t]+|[ \t]+$", "");
                selection = selection.replaceAll("grey\">", "");
                return selection;
            }
            else {
...
//    }
    ...
    public static void main(String[] args) {
        final String filename = "src/a06/Resources/airportcityTerm.txt";
        final int k = 5;
